...
def sendOTPmail(input_email, OTP):
    ...
    body = """
	Dear Customer, 
	You have requested to update profile for YourFirstComputer account. 
	Here is your OTP: """ + OTP + """

	Note: 
	- OTP will only be valid for 1 minute.
	"""
...
def sendUpdationConfirmationMail(input_email, updatedFields):
    ...
    body = f"""
	Dear Customer, 
	This is a confirmation email that {(", ").join(updatedFields)} for your account {input_email} has been updated.
	"""
