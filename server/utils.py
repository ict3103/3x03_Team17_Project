...
def handleUpdates(account: tuple = None, **updatedValues: dict) -> dict:
    ...
    1- password update will be different from other values updation as it will be hashed value. So, it will be handled separately
    ...
    if account is not None:
        ...
        if updatedValues["email"] is not None:
            emailUpdated = handleEmail(
                account[2], updatedValues["email"], account[2])
